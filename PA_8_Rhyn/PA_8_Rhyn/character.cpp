...
bool character::check_left  (sf::Sprite theSprite, obstacle* theObstacle, int nObstacles)
{
	bool valid = false;
	...
	for (int i=0; i< nObstacles; i++)
	{
		...
		sf::FloatRect obstacleBox = theObstacle[i].collisionZone;
		
		//cout << boundingBox.left << endl;
		//cout << obstacleBox.left << endl;
...
// check_right
bool character::check_right (sf::Sprite theSprite, obstacle* theObstacle, int nObstacles)
{
	bool valid = false;
	for (int i=0; i< nObstacles; i++)
	{
...
// check_up
bool character::check_up (sf::Sprite theSprite, obstacle* theObstacle, int nObstacles)
{
	bool valid = false;
	for (int i=0; i< nObstacles; i++)
	{
...
// check_down
bool character::check_down (sf::Sprite theSprite, obstacle* theObstacle, int nObstacles)
{
	bool valid = false;
	for (int i=0; i< nObstacles; i++)
	{
